	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		response.setContentType("text/html");
	      ...
	      for(int i=0; i<a.length;i++)
	      	 tr += a[i]+ ".";  // no space, comma allowed in cookie values
	      
	      Cookie c1 = new Cookie ("uname", name);
	      Cookie c2 = new Cookie ("upass", password+"xxx" );
	      Cookie c3 = new Cookie ("uyear", year);
	      Cookie c4 = new Cookie ("ugroup", group);
	      Cookie c5 = new Cookie ("utr", tr );
